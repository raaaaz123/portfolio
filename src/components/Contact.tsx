...
const contactLinks = [
  {
    ...
    color: 'group-hover:text-primary dark:group-hover:text-primary',
    bg: 'group-hover:bg-primary dark:group-hover:bg-primary/10 group-hover:border-primary/60 dark:group-hover:border-primary/20',
  },
  {
    name: 'WhatsApp',
...
const ContactCard: React.FC<{
  ...
  <motion.a
    ...
    whileHover={{ y: -3 }}
    whileTap={{ scale: 0.98 }}
    className="group flex items-center gap-4 p-4 rounded-xl bg-card border border-border/60 hover:shadow-md hover:shadow-primary/[0.03] transition-all duration-300"
  >
    {/* Icon */}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-2xl mx-auto">
          ...
          >
            <motion.a
              href={`mailto:${personalInfo.email}`}
              className="group flex-1 inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl font-semibold text-sm text-primary-foreground bg-primary hover:bg-primary/90 border-transparent border shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/30 transition-all duration-300"
              whileHover={{ y: -2 }}
              whileTap={{ scale: 0.97 }}
            >
              <FiMail size={16} />
            ...
            <motion.a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl font-semibold text-sm border border-border/80 dark:border-border text-foreground bg-card hover:bg-secondary dark:hover:bg-secondary/80 hover:border-primary/30 dark:hover:border-primary/30 transition-all duration-300"
              whileHover={{ y: -2 }}
              whileTap={{ scale: 0.97 }}
            >
